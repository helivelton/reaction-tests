...
const int sensorAbd = 9;
  ...
  inicioTeste = millis();
  fTeste = inicioTeste + 120000;
  int estimulos=0;
 
 
   while((millis()<=fTeste) & estimulos < 20){
...
void testeB(int numSensores){	//funÃƒÂ§ÃƒÂ£o do teste tipo 2
...
const int sensorAbd = 9;
  ...
  int estimulos=0;
   ...
   switch(led){
    ...
    botoesErro(led);
   if(anterior != led){ // quando o mesmo led da leitura anterior ÃƒÂ© selecionado, o processo de leitura nÃƒÂ£o ÃƒÂ© executado 
